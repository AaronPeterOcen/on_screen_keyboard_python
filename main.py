...
def Theme():
    ...
    if theme == "dark":
        ...
        style.configure("TButton", background="gray27")
...
def display():
    if is_shift:
        ...
        tab_button = ttk.Button(key, text="Tab", width=6, command=lambda: press("\t"))
        ...
        curly_l = ttk.Button(key, text="{", width=6, command=lambda: press("{"))
        curly_l.grid(row=2, column=12, ipadx=6, ipady=10)

        curly_r = ttk.Button(key, text="}", width=6, command=lambda: press("}"))
        ...
        quotation = ttk.Button(key, text='"', width=6, command=lambda: press('"'))
        ...
        enter = ttk.Button(key, text="Enter", width=6, command=lambda: press("\n"))
        ...
        question = ttk.Button(key, text="?", width=6, command=lambda: press("?"))
